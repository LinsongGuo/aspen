...
SERVER_COMMAND = {
    ...
    'signal': 'apps/rocksdb_concord/rocksdb_server',
    'uintr': 'apps/rocksdb_concord/rocksdb_server',
    'concord-fine_tuned': 'apps/rocksdb_concord/rocksdb_server_concord',
    'concord': 'apps/rocksdb_concord/rocksdb_server_concord_fl',
}
...
# The results and logs will appear in `experiments/result/fig5`. 
...
if __name__ == '__main__':
    ...
    for quantum in PREEMPT_QUANTUM[option]:
        ...
        client_result_path = os.path.join(EXP_PATH, 'result', 'fig5', option, str(quantum), name)
        ...
        evaluate(option, client_result_path, server_config_path, quantum, mpps=2, start_mpps=0, samples=50)