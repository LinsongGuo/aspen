...
ax.set_xticks(x)
ax.set_xticklabels(work_name, fontsize=11)
ax.set_ylabel(r'Average Cost ($\mu{}$s)', fontsize=12)
ax.set_ylim(top=5)
ax.set_xlim(left=0.3, right=7.7)

plt.legend(new_handles, new_labels, ncol=3, fontsize=11, handlelength=1.2, handletextpad=0.3, columnspacing=0.8, loc='upper center', frameon=False, bbox_to_anchor=(0.475, 1.36))
plt.subplots_adjust(
    left=0.057,   
    right=0.98, 
    bottom=0.17,  
